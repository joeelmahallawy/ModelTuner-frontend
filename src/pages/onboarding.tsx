...
const OnboardingPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Onboarding - ModelTuner</title>
      </Head>
      <Center sx={{ height: "70vh" }}>
        <Box>
          <Title>Welcome to ModelTuner!</Title>
          ...
          >
            <Title fw={500} order={5}>
              This step is absolutely necessary to use ModelTuner, are you sure
              you want to set your API key later?
            </Title>
